...
set(CMAKE_C_FLAGS "--specs=nosys.specs -mthumb -Wall -Wextra -Wshadow -Wundef -Wconversion -W -g3 -u interrupt_vector_table -O0 -fstack-usage -ffreestanding -fno-common -ffunction-sections -fdata-sections -nostartfiles -Wl,--gc-sections -Wl,-static -Wl,-Map=main.map -T ${LINKER_SCRIPT} -L ${LINKER_DIR}") # -nostdlib -nostdinc
